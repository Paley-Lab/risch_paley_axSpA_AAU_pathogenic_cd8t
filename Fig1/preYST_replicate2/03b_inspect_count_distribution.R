...
control_cols     <- c('Pre_YST_rep3_startingLibrary', 'Pre_YST_rep3_no_peptide')
experiment_cols  <- c(c("Pre_YST_rep3_YeiH", "Pre_YST_rep3_GPER1",
                        "Pre_YST_rep3_PRPF3", "Pre_YST_rep3_PSG5", "Pre_YST_rep3_RNASEH2b"))
