...
```bash
cd /storage1/fs1/paleym/Active/SeqData/MP163/20260624_preYST_Library_Rep2/
mkdir trimmed_fastq
...
```bash
cd /storage1/fs1/paleym/Active/SeqData/MP163/20260624_preYST_Library_Rep2/trimmed_fastq
for Sample in *_L00*_R1_001.fastq.gz; do
  S1="${Sample%_L00*_R1_001.fastq.gz}";
  S2="${Sample%_R1_001.fastq.gz}";
  echo "${S1},/storage1/fs1/paleym/Active/SeqData/MP163/20260624_preYST_Library_Rep2/trimmed_fastq/${S2}_R1_001.fastq.gz,/storage1/fs1/paleym/Active/SeqData/MP163/20260624_preYST_Library_Rep2/trimmed_fastq/${S2}_R2_001.fastq.gz" >> samples_trimmed.csv
done
```
...
```r
meta2 <- read.csv("../../SeqData/MP163/20260624_preYST_Library_Rep2/Samplemap2.csv")
tmp <- read.csv("../../SeqData/MP163/20260624_preYST_Library_Rep2/trimmed_fastq/samples_trimmed.csv", header = F)
meta <- meta2[,c(1,11)]
